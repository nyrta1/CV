...
const projects = [
    ...
    },
    {
        ...
        "created_at": 2023,
        "project_description": "Это учебный онлайн-сайт, где учащиеся могут легко учиться. Простой интерфейс позволяет понять, как все работает. К каждому уроку есть комментарии, чтобы вы могли общаться и задавать вопросы друг другу.",
